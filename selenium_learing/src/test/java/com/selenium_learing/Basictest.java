...
// TO ADD Basic details in create new account
		...
		driver.findElement(By.name("reg_email__")).sendKeys("megha22061996@gmail.com");
		driver.findElement(By.name("reg_email_confirmation__")).sendKeys("megha22061996@gmail.com");
		driver.findElement(By.name("reg_passwd__")).sendKeys("Kunj@8866");
